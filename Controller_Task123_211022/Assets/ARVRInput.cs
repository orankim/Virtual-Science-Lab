...
public static class ARAVRInput
{
    ...
    {
#if PC
        One = ButtonTarget.Fire1, //마우스왼쪽버튼
        Two = ButtonTarget.Jump, //스페이스바
        Thumbstick = ButtonTarget.Fire1,
        IndexTrigger = ButtonTarget.Fire3, //마우스휠버튼
        ...
        Two = ButtonTarget.Jump, //터치패드 클릭
        Thumbstick = ButtonTarget.Teleport,
        IndexTrigger = ButtonTarget.InteractUI, //아래 트리거버튼
